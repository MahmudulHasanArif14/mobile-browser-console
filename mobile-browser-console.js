/**
 * @overview Creates a mock JavaScript console for testing pages in mobile browsers.
...
;var MobileBrowserConsole = (function(){
	...
	/**
	 * @description Builds new DOM elements and defines new methods.
	 */
	 ...
	 */
	var insertStyleRule = function(sheet, selector, rule, index) {
		if(sheet.insertRule) {
	 ...
	 */
	var setStyle = function(elms, cssObj) {
...
/**
 * Since the most likely use case is to dynamically create this script to
 * test mobile pages, it will be easier to assume it should be started.
 *
 * To prevent this, add the line below to your HTML
 * before importing mobile-browser-console.js
 *
 *   <script>window.delayConsole = true;</script>
 *
 */
